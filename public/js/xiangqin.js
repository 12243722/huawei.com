...
(function() {
        let id = location.search.search('=')[1]; //获得商品id
        //  console.log(id);
        $.ajax({
            type: "get",
            ...
            success: function(res) {
                ...
                let template = `<div class="head-top">
            ...
            <div class="wrapper clearfix">
                ...
                <div class="page">
                    ...
                    <div class="right information">
                        ...
                        <div class="addshop">
                            <div class="number"><a class="a-1" href="#">+</a><a class="a-2" href="#">-</a>1</div>
                            <div class="free">免费登记</div>
